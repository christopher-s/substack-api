...
export const SubstackPublicationFullPostCodec = t.intersection([
  ...
  t.partial({
    ...
    social_title: maybe(t.union([t.string, t.null])),
    search_engine_title: maybe(t.union([t.string, t.null])),
    search_engine_description: maybe(t.union([t.string, t.null])),
    video_upload_id: maybe(t.union([t.string, t.null])),
    podcast_upload_id: maybe(t.union([t.string, t.null])),
    ...
    default_comment_sort: maybe(t.union([t.string, t.null])),
